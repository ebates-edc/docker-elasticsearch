...
Configure it for your needs through the `gce.env` file. Make sure you have an environment variable `PROJECT_ID` defined with your google project ID and gcloud is insalled and configured.
...
# User Feedback
## Issues
If you have any problems with or questions about this image, please ask for help through a [GitHub issue](https://github.com/ebates-edc/docker-elasticsearch/issues).
